...
- Use PhoenixTest (https://hexdocs.pm/phoenix_test/PhoenixTest.html) for testing both LiveView or dead view
...
2. **Run quality gates** (if code changed) - Tests, linters, builds: `mix precommit`
